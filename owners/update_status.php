		                        ...
		                        <div id="" class="block">
									...
									?>
									 ...
									 <form class="form-horizontal" method="post">
										...
										mysqli_query($conn,"insert into activity_log (date,username,action) values(NOW(),'$admin_username','Update Status $dev_name to $dev_status')")or die(mysqli_error($conn));			
										?>
										<script>
