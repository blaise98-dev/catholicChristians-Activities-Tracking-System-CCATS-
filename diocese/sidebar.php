   ...
   <div class="span3" id="sidebar">
     ...
     <ul class="nav nav-list bs-docs-sidenav nav-collapse collapse">
       ...
       <li>
         <a href="javascript:;" role="button" class="dropdown-toggle" data-toggle="collapse" data-target="#bs2"><i class="icon-chevron-right"></i><i class="icon-group"></i>&nbsp;manage Parishes
           <div class="muted pull-right"><i class="caret"></i></div>
         </a>
         <ul id="bs2" class="collapse">

         <li class="">
             <a href="admin_user.php"><i class="icon-chevron-right"></i><i class="icon-user"></i>&nbsp;Active Parishes</a>
           </li><li class="">
             <a href="inactive_users.php"><i class="icon-chevron-right"></i><i class="icon-user"></i>&nbsp;Inactive Parishes</a>
           </li>
         </ul>
       </li>
