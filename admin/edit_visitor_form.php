	...
	$('#add').tooltip('hide');
                        ...
                        <div class="block">
                            ...
                            <div class="block-content collapse in">
                                <div class="span12">
								<?php
								$query = mysqli_query($conn,"select * from visitor where id = '$get_visitor_id' and visitor.host_parish='" . $_SESSION['id'] . "'")or die(mysqli_error($conn));
...
mysqli_query($conn,"UPDATE visitor SET fname = '$fname',lname='$lname',Gender='$Gender',Birthday='$birthday', Residence='$residence',pob='$pob',ministry='$ministry',mobile='$mobile'  where id='$get_visitor_id'") 
or die(mysqli_error($conn));

mysqli_query($conn,"insert into activity_log (date,username,action)
 values(NOW(),'$admin_username','Edited Visitor $sname')")or die(mysqli_error($conn));
?>
<script>
