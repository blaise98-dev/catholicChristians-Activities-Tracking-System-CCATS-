    ...
    <body>
        ...
        <div class="container-fluid">
            <div class="row-fluid">
				...
				<?php	
	             $count_members=mysqli_query($conn, "SELECT * FROM `members` WHERE MONTH(members.Birthday)>=MONTH(CURDATE());");
...
<!-----------------------------------Content------------------------------------>
<?php
		$members_query = mysqli_query($conn, "SELECT * FROM `members`;")or die(mysqli_error($conn));
