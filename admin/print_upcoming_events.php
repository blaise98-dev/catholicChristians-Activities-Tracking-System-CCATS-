...
"Times New Roman","serif"'>
 ...
 mso-yfti-tbllook:1184;mso-padding-alt:0in 5.4pt 0in 5.4pt'>
  ...
  mso-background-themeshade:191;padding:0in 5.4pt 0in 5.4pt;height:23.25pt'>
                                                    <p class=msoNormal style='margin-bottom:0in;margin-bottom:.0001pt;line-height:
  normal'><b style='mso-bidi-font-weight:normal'><span style='font-family:"Times New Roman","serif"'>Event name<o:p></o:p></span></b></p>
                                                </td>
  ...
  191;padding:0in 5.4pt 0in 5.4pt;height:23.25pt'>
                                                    <p class=msoNormal style='margin-bottom:0in;margin-bottom:.0001pt;line-height:
  normal'><b style='mso-bidi-font-weight:normal'><span style='font-family:"Times New Roman","serif"'>Description<o:p></o:p></span></b></p>
                                                </td>

                                                <!-- mysqli FETCH ARRAY-->
                                                <?php
                                                $student_query = mysqli_query($conn, "SELECT * FROM `event` WHERE Date >= CURDATE()event.parish='" . $_SESSION['id'] . "';") or die(mysqli_error($conn));
  ...
  padding:0in 5.4pt 0in 5.4pt'>
                                                    <p class=msoNormal style='margin-bottom:0in;margin-bottom:.0001pt;line-height:
  normal'><span style='font-family:"Times New Roman","serif"'><?php echo $row['Title']; ?><o:p></o:p></span></p>
                                                </td>
  ...
  mso-border-alt:solid windowtext .5pt;padding:0in 5.4pt 0in 5.4pt'>
                                                    <p class=msoNormal style='margin-bottom:0in;margin-bottom:.0001pt;line-height:
  normal'><span style='font-family:"Times New Roman","serif"'><?php echo $row['content']; ?><o:p></o:p></span></p>
                                                </td>
