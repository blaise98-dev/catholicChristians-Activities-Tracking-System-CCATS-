   ...
   <div class="span3" id="sidebar">
     ...
     <ul class="nav nav-list bs-docs-sidenav nav-collapse collapse">
       ...
       <!--- Subparish and Communities management------->
       <li>
         <a href="javascript:;" role="button" class="dropdown-toggle" data-toggle="collapse" data-target="#bs7"><i class="icon-chevron-right"></i><i class="icon-group"></i>&nbsp;manage Subparish &Communities
           <div class="muted pull-right"><i class="caret"></i></div>
         </a>
         <ul id="bs7" class="collapse">
           <li class="">
             <a href="subparishDetail.php"><i class="icon-chevron-right"></i><i class="icon-group"></i> Subparish Details</a>
           </li>
           <li class="">
             <a href="communityDetail.php"><i class="icon-chevron-right"></i><i class="icon-group"></i> Communities Details</a>
           </li>

           <li>
             <a href="add_subparish.php"><i class="icon-chevron-right"></i><i class="icon-plus-sign-alt"></i> Add Subparish
             </a>
           </li>
           <li>
             <a href="add_community.php"><i class="icon-chevron-right"></i><i class="icon-plus-sign-alt"></i> Add Community.
             </a>
           </li>
       ...
       <!--- Ministries and MAC management------->
       <li>
         <a href="javascript:;" role="button" class="dropdown-toggle" data-toggle="collapse" data-target="#bs3"><i class="icon-chevron-right"></i><i class="icon-group"></i>&nbsp;manage Choirs &Associations
           <div class="muted pull-right"><i class="caret"></i></div>
         </a>
         <ul id="bs3" class="collapse">
           <li class="">
             <a href="choirsDetail.php"><i class="icon-chevron-right"></i><i class="icon-group"></i> Choir Details</a>
           </li>
           <li class="">
             <a href="associationsDetail.php"><i class="icon-chevron-right"></i><i class="icon-group"></i> Association Details</a>
           </li>

           <li>
             <a href="add_choir.php"><i class="icon-chevron-right"></i><i class="icon-plus-sign-alt"></i> Add Choir
             </a>
           </li>
           <li>
             <a href="add_association.php"><i class="icon-chevron-right"></i><i class="icon-plus-sign-alt"></i> Add Association.
             </a>
           </li>
       ...
       <li>
         ...
         <ul id="bs1" class="collapse">
           ...
           <li class="">
             <a href="visitor_offerings.php"><i class="icon-chevron-right"></i><i class="icon-money"></i> Visitor offerings</a>
           </li>
           <li class="">
       ...
       <li>
         ...
         <ul id="bs5" class="collapse">
           ...
           <li class="">
             <a href="previous_events.php"><i class="icon-chevron-right"></i><i class="icon-trophy"></i> Previous Events </a>
           </li>
         </ul>
       </li>
