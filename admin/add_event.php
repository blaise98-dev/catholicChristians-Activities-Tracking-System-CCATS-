   <div class="row-fluid">
				...
				<table>
					...
					<tr>
						<td>
							<textarea name="content" placeholder="Description" class="text" required></textarea>
						</td>
					</tr>
					<tr>
...
if(isset($_POST['send'])){
						...
						$content = $_POST['content'];
							$qry = "INSERT INTO event (Title,Date,content,parish)
							VALUES('$title','$date','$content','" . $_SESSION['id'] . "')";
