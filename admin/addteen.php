...
<div class="block-content collapse in">
  ...
  <option value="Female">Female</option>
                                ...
                                <p> <div class="controls">
                                   <p>
                                     <input class="input focused" name="mobile" id="focusedInput" type="text" placeholder = " parent's mobile number" required> 
                                   </p>
                                 </div>
                                  </div>
								  </p>
...
$query = @mysqli_query($conn,"select * from teens where  mobile = '$mobile'  ")or die(mysqli_error($conn));
...
values('$fname','$sname','$lname','$Gender','$birthday','$residence','$pob','$ministry','$mobile','uploads/none.png',$mobile)")or die(mysqli_error($conn));
