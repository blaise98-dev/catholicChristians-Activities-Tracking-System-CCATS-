    ...
    <body>
        ...
        <div class="container-fluid">
            <div class="row-fluid">
				...
				<?php	
	             $count_members=mysqli_query($conn, "select * from event where parish='" . $_SESSION['id'] . "'");
                            ...
                            <div class="block-content collapse in">
								...
								<form action="delete_members.php" method="post">
									...
									<?php include('modal_delete.php'); ?>
										...
										<tbody>
													<?php
													$user_query = mysqli_query($conn, "select * from event where parish='" . $_SESSION['id'] . "' ")or die(mysqli_error($conn));
