		...
		<div class="row-fluid">
			...
			<div class="span6" id="">
				<div class="row-fluid">
					...
					<?php
					$count_visitors = mysqli_query($conn, "select * from visitor where visitor.host_parish='" . $_SESSION['id'] . "'");
							...
							<div class="span12">
								<form action="delete_visitors.php" method="post">
									<table cellpadding="0" cellspacing="0" border="0" class="table" id="example">
										...
										<tbody>
											<?php
											$visitors_query = mysqli_query($conn, "select * from visitor where visitor.host_parish='" . $_SESSION['id'] . "'") or die(mysqli_error($conn));
											while ($row = mysqli_fetch_array($visitors_query)) {
												$id = $row['id'];
											?>
