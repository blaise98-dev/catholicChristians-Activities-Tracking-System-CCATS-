...
"Times New Roman","serif"'>DATE: <?php
           ...
           "Times New Roman","serif"'>
            ...
            normal'><span style='font-size:12.0pt;mso-bidi-font-size:11.0pt;font-family:
           "Times New Roman","serif"'>
                                                        <a id="return" data-placement="top" class="btn btn-success" title="Click to Return" href="subparishDetail.php"><i class="icon-arrow-left"></i> Back</a></p>
                                                <script type="text/javascript">
                                                    $(document).ready(function() {
                                                        $('#return').tooltip('show');
                                                        $('#return').tooltip('hide');
...
"Times New Roman","serif"'>
 ...
 mso-yfti-tbllook:1184;mso-padding-alt:0in 5.4pt 0in 5.4pt'>
  ...
  mso-background-themeshade:191;padding:0in 5.4pt 0in 5.4pt;height:23.25pt'>
                                                    <p class=msoNormal style='margin-bottom:0in;margin-bottom:.0001pt;line-height:
  normal'><b style='mso-bidi-font-weight:normal'><span style='font-family:"Times New Roman","serif"'>Subparish name<o:p></o:p></span></b></p>
                                                </td>
  ...
  normal'><b style='mso-bidi-font-weight:normal'><span style='font-family:"Times New Roman","serif"'>Contacts<o:p></o:p></span></b></p>
                                                ...
                                                <!-- mysqli FETCH ARRAY-->
                                                <?php
                                                $student_query = mysqli_query($conn, "select * from subparish where parish='" . $_SESSION['id'] . "' ") or die(mysqli_error($conn));
