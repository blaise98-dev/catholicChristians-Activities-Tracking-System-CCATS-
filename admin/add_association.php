    ...
    <div class="container-fluid">
        <div class="row-fluid">
            ...
            <div class="span3" id="addmembers">
                <?php include('addassociation.php'); ?>
            </div>
            <div class="span6" id="">
                <div class="row-fluid">
                    <!-- block -->
                    ...
                    <?php
                    $count_members = mysqli_query($conn, "select * from associations where parish='" . $_SESSION['id'] . "'");
                    $count = mysqli_num_rows($count_members);
                    ?>
                    <div id="block_bg" class="block">
                        <div class="navbar navbar-inner block-header">
                            <div class="muted pull-left"></i><i class="icon-members"></i> Church Association(s) List</div>
                            ...
                            <div class="span12">
                                <form action="delete_association.php" method="post">
                                    <table cellpadding="0" cellspacing="0" border="0" class="table" id="example">
                                        <a data-placement="right" title="Click to Delete check item" data-toggle="modal" href="#delete_association" id="delete" class="btn btn-danger" name=""><i class="icon-trash icon-large"> Delete</i></a>
