...
"Times New Roman","serif"'>DATE: <?php
           ...
           "Times New Roman","serif"'>
            ...
            normal'><span style='font-size:12.0pt;mso-bidi-font-size:11.0pt;font-family:
           "Times New Roman","serif"'>
                                                        <a id="return" data-placement="top" class="btn btn-success" title="Click to Return" href="previous_events.php"><i class="icon-arrow-left"></i> Back</a></p>
                                                <script type="text/javascript">
                                                    $(document).ready(function() {
                                                        $('#return').tooltip('show');
                                                        $('#return').tooltip('hide');
...
"Times New Roman","serif"'>
 ...
 mso-yfti-tbllook:1184;mso-padding-alt:0in 5.4pt 0in 5.4pt'>
  ...
  normal'><b style='mso-bidi-font-weight:normal'><span style='font-family:"Times New Roman","serif"'>Description<o:p></o:p></span></b></p>
                                                ...
                                                <!-- mysqli FETCH ARRAY-->
                                                <?php
                                                $student_query = mysqli_query($conn, "SELECT * FROM `event` WHERE Date <= CURDATE() and parish='" . $_SESSION['id'] . "';") or die(mysqli_error($conn));
