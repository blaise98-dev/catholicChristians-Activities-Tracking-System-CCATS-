...
"Times New Roman","serif"'>DATE: <?php
                                  ...
                                  ?><o:p></o:p></span></p>
                                  <h2>List of Visitors of <?php echo $_SESSION['username']?> parish</h2>
           ...
           "Times New Roman","serif"'>
            ...
            normal'><span style='font-size:12.0pt;mso-bidi-font-size:11.0pt;font-family:
           "Times New Roman","serif"'>
                            <a id="return" data-placement="top" class="btn btn-success" title="Click to Return" href="visitor_offerings.php"><i class="icon-arrow-left"></i> Back</a></p>
                        <script type="text/javascript">
                          $(document).ready(function() {
                            $('#return').tooltip('show');
                            $('#return').tooltip('hide');
...
"Times New Roman","serif"'>
 ...
 mso-yfti-tbllook:1184;mso-padding-alt:0in 5.4pt 0in 5.4pt'>
  ...
  191;padding:0in 5.4pt 0in 5.4pt;height:23.25pt'>
                          <p class=msoNormal style='margin-bottom:0in;margin-bottom:.0001pt;line-height:
  normal'><b style='mso-bidi-font-weight:normal'><span style='font-family:"Times New Roman","serif"'>Offering type<o:p></o:p></span></b></p>
                        </td>
                        <td width=188 style='width:140.9pt;border:solid windowtext 1.0pt;border-left:
  none;mso-border-left-alt:solid windowtext .5pt;mso-border-alt:solid windowtext .5pt;
  background:#BFBFBF;mso-background-themecolor:background1;mso-background-themeshade:
  ...
  normal'><b style='mso-bidi-font-weight:normal'><span style='font-family:"Times New Roman","serif"'>Date<o:p></o:p></span></b></p>
                        ...
                        $student_query = mysqli_query($conn, "select * from non_registered_user_offering WHERE non_registered_user_offering.status='paid'and parish='" . $_SESSION['id'] . "' ") or die(mysqli_error($conn));
  ...
  mso-border-alt:solid windowtext .5pt;padding:0in 5.4pt 0in 5.4pt'>
                          <p class=msoNormal style='margin-bottom:0in;margin-bottom:.0001pt;line-height:
  normal'><span style='font-family:"Times New Roman","serif"'><?php echo $row['date']; ?><o:p></o:p></span></p>
                        </td>
                      ...
                      <?php
                        $student_query = mysqli_query($conn, "select sum(amount) as totalofferings from non_registered_user_offering WHERE non_registered_user_offering.status='paid'and parish='" . $_SESSION['id'] . "'") or die(mysqli_error($conn));
                        while ($row = mysqli_fetch_array($student_query)) {
                          $RegNo = $row['id'];
                        ?>
  ...
  mso-border-alt:solid windowtext .5pt;padding:0in 5.4pt 0in 5.4pt'>
                          <p class=msoNormal style='margin-bottom:0in;margin-bottom:.0001pt;line-height:
  normal'><span style='font: size 30px;font-weight:bold;font-family:"Times New Roman","serif"'>Total offerings<o:p></o:p></span></p>
                        </td>
  ...
  mso-border-alt:solid windowtext .5pt;padding:0in 5.4pt 0in 5.4pt'>
                          <p class=msoNormal style='margin-bottom:0in;margin-bottom:.0001pt;line-height:
  normal'><span style='font: size 30px;font-weight:bold; font-family:"Times New Roman","serif"'><?php echo $row['totalofferings']; ?> Rwf<o:p></o:p></span></p>
                        </td>
                      <?php } ?>
                      <!--mysqli FETCH ARRAY-->
                      </tr>
