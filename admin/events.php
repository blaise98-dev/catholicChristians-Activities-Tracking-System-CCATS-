    ...
    <body>
        ...
        <div class="container-fluid">
            <div class="row-fluid">
				...
				<?php	
	             $count_event=mysqli_query($conn, "select * from event where event.parish='" . $_SESSION['id'] . "' ");
	             $count = mysqli_num_rows($count_event);
                 ?>	 
                        <div id="block_bg" class="block">
                            <div class="navbar navbar-inner block-header">
                                <div class="muted pull-left"></i><i class="icon-user"></i> Event List</div>
                            ...
                            <div class="block-content collapse in">
								...
								<form action="delete_events.php" method="post">
									...
									<?php include('modal_delete.php'); ?>
										...
										<tbody>
													<?php
													$user_query = mysqli_query($conn, "select * from event where event.parish='" . $_SESSION['id'] . "' ")or die(mysqli_error($conn));
