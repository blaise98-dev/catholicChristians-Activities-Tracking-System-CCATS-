...
font-family:"Times New Roman","serif"'>Catholic Church Membership System </span></b></p>

            <p class=msoNormal align=center style='margin-bottom:0in;margin-bottom:.0001pt;
text-align:center;line-height:normal'><b><span style='font-size:7.0pt;
font-family:"Times New Roman","serif"'>Powered by Catholic Church Membership System <?php
                                                                                    $date = new DateTime();
                                                                                    echo $date->format('Y');
                                                                                    ?></span></b></p>
...
"Times New Roman","serif"'>
 ...
 mso-yfti-tbllook:1184;mso-padding-alt:0in 5.4pt 0in 5.4pt'>
  ...
  normal'><b style='mso-bidi-font-weight:normal'><span style='font-family:"Times New Roman","serif"'>ministry<o:p></o:p></span></b></p>
                        ...
                        <!-- mysqli FETCH ARRAY-->
                        <?php
                        $student_query = mysqli_query($conn, "select * from members where Residence='" . $_SESSION['id'] . "'") or die(mysqli_error($conn));
