		...
		<div class="row-fluid">
			...
			<div class="span6" id="">
				<div class="row-fluid">
					...
					<?php
					$count_user = mysqli_query($conn, "select * from tithe Where na= '$session_id' and tithe.status='paid'");
					$count = mysqli_num_rows($count_user);
					?>
					<div id="block_bg" class="block">
						<div class="navbar navbar-inner block-header">
							<div class="muted pull-left"></i><i class="icon-user"></i> Tithe List</div>
							...
							<div class="span12">
								<form action="delete_user_tithes.php" method="post">
									<table cellpadding="0" cellspacing="0" border="0" class="table" id="example">
										...
										<tbody>
											<?php
											$user_query = mysqli_query($conn, "select * from members INNER JOIN tithe ON members.id=tithe.na where na='$session_id' and tithe.status='paid'") or die(mysqli_error($conn));
