		...
		<div class="row-fluid">
			<div class="span9" id="content">
				<div class="row-fluid">
					...
					<?php
					$count_student = mysqli_query($conn, "select * from tithe where na='$session_id' and tithe.status='paid'");
								...
								<form action="" method="post">
									<table cellpadding="0" cellspacing="0" border="0" class="table" id="example">
										...
										<tbody>
											<!-----------------------------------Content------------------------------------>
											<?php
											$student_query = mysqli_query($conn, "SELECT *FROm members  LEFT OUTER JOIN tithe ON members.id = tithe.na WHERE tithe.na ='$session_id' and tithe.status='paid' ") or die(mysqli_error($conn));
