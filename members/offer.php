        ...
        <div class="row-fluid">
            <div class="span9" id="content">
                <div class="row-fluid">
                    ...
                    <?php
                    $count_student = mysqli_query($conn, "select * from offering where na='$session_id'");
                                ...
                                <form action="" method="post">
                                    <table cellpadding="0" cellspacing="0" border="0" class="table" id="example">
                                        ...
                                        <tbody>
                                            <!-----------------------------------Content------------------------------------>
                                            <?php
                                            $student_query = mysqli_query($conn, "SELECT *FROm members  LEFT OUTER JOIN offering ON members.id = offering.na WHERE offering.na ='$session_id' ") or die(mysqli_error($conn));
