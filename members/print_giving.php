...
"Times New Roman","serif"'>
 ...
 mso-yfti-tbllook:1184;mso-padding-alt:0in 5.4pt 0in 5.4pt'>
  ...
  normal'><b style='mso-bidi-font-weight:normal'><span style='font-family:"Times New Roman","serif"'>Date<o:p></o:p></span></b></p>
                        ...
                        <!-- mysqli FETCH ARRAY-->
                        <?php
                        $student_query = mysqli_query($conn, "select * from members INNER JOIN giving ON members.mobile=giving.na where giving.na='$session_id' ") or die(mysqli_error($conn));
  ...
  normal'><span style='font-family:"Times New Roman","serif"'><?php echo $row['paytime']; ?><o:p></o:p></span></p>
                      ...
                      <?php
                        $student_query = mysqli_query($conn, "select sum(amount) as totalgiving from members INNER JOIN giving ON members.mobile=giving.na and giving.na='$session_id' ") or die(mysqli_error($conn));
                        while ($row = mysqli_fetch_array($student_query)) {
                          $RegNo = $row['id'];
                        ?>
  ...
  mso-border-alt:solid windowtext .5pt;padding:0in 5.4pt 0in 5.4pt'>
                          <p class=msoNormal style='margin-bottom:0in;margin-bottom:.0001pt;line-height:
  normal'><span style='font: size 30px;font-weight:bold;font-family:"Times New Roman","serif"'> My Total givings<o:p></o:p></span></p>
                        </td>
