...
"Times New Roman","serif"'>
 ...
 mso-yfti-tbllook:1184;mso-padding-alt:0in 5.4pt 0in 5.4pt'>
  ...
  normal'><b style='mso-bidi-font-weight:normal'><span style='font-family:"Times New Roman","serif"'>Date<o:p></o:p></span></b></p>
                        ...
                        <!-- mysqli FETCH ARRAY-->
                        <?php
                        $student_query = mysqli_query($conn, "select * from members INNER JOIN offering ON members.mobile=offering.na and offering.na='$session_id' ") or die(mysqli_error($conn));
  ...
  normal'><span style='font-family:"Times New Roman","serif"'><?php echo $row['paytime']; ?><o:p></o:p></span></p>
                      ...
                      <?php
                        $student_query = mysqli_query($conn, "select sum(amount) as totaloffering from members INNER JOIN offering ON members.mobile=offering.na and offering.na='$session_id' ") or die(mysqli_error($conn));
                        while ($row = mysqli_fetch_array($student_query)) {
                          $RegNo = $row['id'];
                        ?>
