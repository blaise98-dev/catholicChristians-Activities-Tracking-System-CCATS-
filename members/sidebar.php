    ...
    <div class="span3" id="sidebar">
      ...
      <ul class="nav nav-list bs-docs-sidenav nav-collapse collapse">
        ...
        <li>
          <a href="javascript:;" role="button" class="dropdown-toggle" data-toggle="collapse" data-target="#bs"><i class="icon-chevron-right"></i><i class="icon-money"></i>&nbsp;manage Tithes
            <div class="muted pull-right"><i class="money"></i></div>
          </a>
          <ul id="bs" class="collapse">
            <li class="">
              <a href="Tithe.php"><i class="icon-chevron-right"></i><i class="icon-money"></i> my Tithes</a>
            </li>
            <li class="">
        ...
        <!------/.* finance sidebar*------->
        <li>
          <a href="javascript:;" role="button" class="dropdown-toggle" data-toggle="collapse" data-target="#bs1"><i class="icon-chevron-right"></i><i class="icon-globe"></i>&nbsp;Manage Givings & Offerings
          ...
          <ul id="bs1" class="collapse">
            ...
            <li class="">
              <a href="offer.php"><i class="icon-chevron-right"></i><i class="icon-money"></i> Offerings</a>
            </li>
            <li class="">
              <a href="offering.php"><i class="icon-chevron-right"></i><i class="icon-money"></i> Offer now</a>
            </li>
            <li>
              <a href="give.php"><i class="icon-chevron-right"></i><i class="icon-money"></i> Givings
              </a>
            </li>
            <li class="">
              <a href="giving.php"><i class="icon-chevron-right"></i><i class="icon-money"></i> Give now</a>
            </li>
        ...
        <li>
          ...
          <ul id="bs5" class="collapse">
            ...
            <li class="">
              <a href="previous_events.php"><i class="icon-chevron-right"></i><i class="icon-calendar"></i> Previous events </a>
            </li>
          </ul>
        </li>
